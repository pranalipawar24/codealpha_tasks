...
It provides instant and accurate responses to queries about internship details, tasks, submissions, certificates, and support.
...
📌 Note
This chatbot uses keyword-based matching, not a generative AI model.
It is designed specifically for internship-related FAQs.
